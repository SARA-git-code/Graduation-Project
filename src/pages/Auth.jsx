...
import don from '../assets/don.jpeg'; // Import the image from the assets folder
...
const Auth = () => {
  ...
  const [phone, setPhone] = useState(""); // Removed default value, placeholder will be used
  const [country, setCountry] = useState("");
  const [fullName, setFullName] = useState(""); // Full Name for Sign Up
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: `url(${don})`, // Use imported image as background
        backgroundSize: "cover",
        backgroundPosition: "center",
        backgroundRepeat: "no-repeat",
        position: "relative", // To enable the form to overlay on the background
      }}
    >
      <div className="p-4 w-100" style={{ maxWidth: '450px', backgroundColor: "rgba(255, 255, 255, 0.23)", borderRadius: '10px', boxShadow: "0 4px 8px rgb(0, 0, 0)" }}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          {/* Password field for Sign Up only */}
